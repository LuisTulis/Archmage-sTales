...
public class AlchemyRoom_Prototipo : MonoBehaviour {
    ...
    [SerializeField] private UnlockRoomUI_Prototipo unlockRoomUI;
    ...
    public void ConfirmUnlock() {
        ...
        GameManager_Prototipo gm = FindObjectOfType<GameManager_Prototipo>();
    ...
    private void UnlockRoom() {
        ...
        if (alchemyStation != null) {
            ...
            WorkStationBehaviour_Prototipo ws = alchemyStation.GetComponentInChildren<WorkStationBehaviour_Prototipo>();
            if (ws != null) {
                WorkstationManager_Prototipo manager = FindObjectOfType<WorkstationManager_Prototipo>();
                if (manager != null)
                    ws.isBroken = false;
