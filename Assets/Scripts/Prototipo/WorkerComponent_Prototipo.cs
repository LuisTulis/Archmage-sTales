...
public class WorkerComponent_Prototipo : BaseWorkerComponent_Prototipo
{
    ...
    protected override void Update()
    {
        ...
        if(model is WorkerModel_Prototipo wm)
        {
            if(wm.mental < 0)
            {
    ...
    {
        GlobalCharactersManager_Prototipo.Instance.FireWorker(this.gameObject.GetComponent<WorkerModel_Prototipo>());
        base.Despawn();
    }
}
