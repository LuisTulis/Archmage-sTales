...
public class WorkStationBehaviour_Prototipo : MonoBehaviour, IPointerClickHandler
{
    public WorkstationData workstationData;

    private WorkstationPanelController_Prototipo infoPanel;
    private GameManager_Prototipo gameManager;
    public string status;
    public Transform workerPosition;
    public Transform clientPosition;
    public int clientUsing = 0;
    public string assignedWorker;
    public Customer_Prototipo assignedCustomer;
    ...
    {
        this.status = "Idle";
        infoPanel = GameObject.Find("WorkStationUI").GetComponent<WorkstationPanelController_Prototipo>();
        gameManager = GameObject.Find("GameManager").GetComponent<GameManager_Prototipo>();
